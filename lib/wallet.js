// Wallet context for AsentumChain.
//
// AsentumChain is post-quantum (Dilithium3) — Ethereum-style wallets
// won't work. We support two connect paths, both speaking the same
// unified API to the rest of the app:
//
//   1. Browser extension (window.asentum)  — the Asentum wallet extension.
//   2. Telegram-backed wallet bot          — 6-digit-code session at
//                                            wallet.asentum.com.
//
// The connect modal lets the user pick. Whichever path they choose, the
// rest of the app calls `callContract()` / `deployContract()` and the
// context routes to the right backend behind the scenes.
