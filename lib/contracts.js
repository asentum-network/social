// Deployed contract addresses + read helpers.
//
// AsentumChain is post-quantum (Dilithium3); we don't need ethers.
// Reads go through the chain's native /view endpoint (cheap, no signer
// required). Writes go through the wallet context (see lib/wallet.js)
// which routes to the extension or the bot, both of which produce
// Dilithium3-signed txs natively.
//
// Contracts (testnet):
//   AsentumProfile  0xf286cad273e10b7af591e34b348c6213c92ade55
//   AsentumPosts    0x58bf25641243162032abd48d1b9a8940ff675db6
